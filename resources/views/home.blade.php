...
<body class="bg-white">
    ...
    <div class="min-h-screen flex flex-col md:flex-row items-center justify-between">
        <div class="text-section flex flex-col items-center ml-15 ">
            <div class="header flex items-end gap-4">
                <h1 class="text-[120px] font-bold text-black leading-none ">Learn</h1>
                <h2 class="text-[120px] font-bold text-orange-600 leading-none">Laravel</h2>
            </div>
            <div class="subheader mt-5 flex text-center">
                <p class="text-3xl ">Master the art of clean, efficient, and elegant web development with Laravel.</p>
            </div>
            <div class="get-started-btn mt-10">
                <a href="#laraveldef" class="mt-40 ml-5 text-2xl bg-orange-600 text-white hover:bg-black hover:text-white px-4 py-2 rounded-xl transition duration-300">
                    Get Started
                </a>
            </div>
        </div>

        <div class="image-section flex justify-center w-4/5">
            <img src="{{ asset('images/laravel.png') }}" alt="Laravel Logo" class="w-full max-w-[1000px] h-auto">
        </div>
    </div>
